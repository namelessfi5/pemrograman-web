<?php 
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      ...
      //query SQL
      $query = "INSERT INTO mhs (nrp, nama, jenis_kelamin, alamat,jurusan ,fakultas, semester) VALUES('$nrp','$nama','$jenis_kelamin','$alamat','$jurusan','$fakultas','$semester')"; 
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <form action="form.php" method="POST">
            ...
            <div class="form-group">
              <label>Jurusan</label>
              <input type="text" class="form-control" placeholder="Jurusan mahasiswa" name="jurusan" required="required">
            </div>
            <div class="form-group">
              <label>Fakultas</label>
              <input type="text" class="form-control" placeholder="Fakultas mahasiswa" name="fakultas" required="required">
            </div>
             <div class="form-group">
              <label>Semester</label>
              <input type="text" class="form-control" placeholder="Semester mahasiswa" name="semester" required="required">
            </div>
